package flexcoral.seedutils.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(SeedUtilsAddon.HUD_GROUP, "example", "HUD element example.", HudExample::new);
